                                    ...
                                    <c:forEach items="${ collectall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改收藏按钮和删除收藏按钮，修改提交地址为updatecollect.action?id=${item.id}，删除提交地址为 deletecollect.action?id=${item.id}-->

                                                <a href="updatecollect.action?id=${item.id}">修改</a> <a
                                                    href="deletecollect.action?id=${item.id}">删除</a>
