...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">修改小说评论</title>
    <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">修改小说评论</h4>
                        </div>
            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="updatenovelpinglunact.action"
                                      method="post" enctype="multipart/form-data">
                                    <input name='id' style='display:none;' value="${novelpinglun.id}">
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为novel的值为request中的novelpinglun.novel  */

                                                    $("#novel").val("${novelpinglun.novel}")</script>
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为novelid的值为request中的novelpinglun.novelid  */

                                                    $("#novelid").val("${novelpinglun.novelid}")</script>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="neirong" class="form-control"
                                                          qw-c="formtextarea">${novelpinglun.neirong}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为pinglunrenmingzi的值为request中的novelpinglun.pinglunrenmingzi  */

                                                    $("#pinglunrenmingzi").val("${novelpinglun.pinglunrenmingzi}")</script>
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为pinglunrenid的值为request中的novelpinglun.pinglunrenid  */

                                                    $("#pinglunrenid").val("${novelpinglun.pinglunrenid}")</script>
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly value="${novelpinglun.pinglunshijian}"
