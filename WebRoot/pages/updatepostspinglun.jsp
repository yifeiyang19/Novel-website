            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="updatepostspinglunact.action"
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <select id='posts' onchange="postschange(this)" name="posts"
                                                    ...
                                                    <!-- 使用c标签的if表达式判断postsall是否为空 -->

                                                    <c:if test="${ !empty postsall}">

                                                        <!-- 使用c标签的forEach表达式循环输出postsall -->
                                                ...
                                                <script>
                                                    ...
                                                    function postschange(select) {
                                                        ...
                                                        /* 获取传入的select的选中项的项数， 将id为postsid的选中项改变为与其一致  */
                                                ...
                                                <script>
                                                    /* 设置id为posts的值为request中的postspinglun.posts  */
                                            ...
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    ...
                                                    function postsidchange(select) {
                                                        ...
                                                        /* 获取传入的select的选中项的项数， 将id为postsidid的选中项改变为与其一致  */
                                                ...
                                                <script>
                                                    /* 设置id为postsid的值为request中的postspinglun.postsid  */
                                    ...
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为pinglunrenmingzi的值为request中的postspinglun.pinglunrenmingzi  */

                                                    $("#pinglunrenmingzi").val("${postspinglun.pinglunrenmingzi}")</script>
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为pinglunrenid的值为request中的postspinglun.pinglunrenid  */

                                                    $("#pinglunrenid").val("${postspinglun.pinglunrenid}")</script>
