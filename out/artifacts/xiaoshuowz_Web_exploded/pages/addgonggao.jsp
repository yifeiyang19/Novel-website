...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">添加公告</title>
    <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">添加公告</h4>
                        </div>
            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="addgonggaoact.action"
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" id="dangqianshijian" name="addtime"
