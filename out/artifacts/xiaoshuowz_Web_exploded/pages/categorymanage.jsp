...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">分类管理</title>
    <meta charset="utf-8">
                ...
                <div class="col xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">分类管理</h4>
                        </div>
                                    ...
                                    <c:forEach items="${ categoryall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改分类按钮和删除分类按钮，修改提交地址为updatecategory.action?id=${item.id}，删除提交地址为 deletecategory.action?id=${item.id}-->
