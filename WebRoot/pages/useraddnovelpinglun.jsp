            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="useraddnovelpinglunact.action"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id='novel' onchange="novelchange(this)" name="novel"
                                                    ...
                                                    <c:if test="${ !empty novelall}">
                                                        ...
                                                        <!-- 使用c标签的forEach表达式循环novelall并将其name字段进行展示 -->
                                            ...
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <select id='novelid' onchange="novelidchange(this)" name="novelid"
                                                    ...
                                                    <c:if test="${ !empty novelall}">
                                                        ...
                                                        <!-- 使用c标签的forEach表达式循环novelall并将其id字段进行展示 -->
