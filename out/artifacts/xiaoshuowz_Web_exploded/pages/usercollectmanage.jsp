...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">收藏管理</title>
    <meta charset="utf-8">
                ...
                <div class="col xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">收藏管理</h4>
                        </div>
                    ...
                    <div class="card table-card">
                        <div class="card-body">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <c:if test="${ !empty collectall}">

                                    <c:forEach items="${ collectall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改收藏按钮和删除收藏按钮，修改提交地址为userupdatecollect.action?id=${item.id}，删除提交地址为 userdeletecollect.action?id=${item.id}-->

                                                <a href="userupdatecollect.action?id=${item.id}">修改</a> <a
                                                    href="userdeletecollect.action?id=${item.id}">删除</a>
