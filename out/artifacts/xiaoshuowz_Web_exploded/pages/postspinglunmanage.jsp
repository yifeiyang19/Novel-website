                                    ...
                                    <c:forEach items="${ postspinglunall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改帖子评论按钮和删除帖子评论按钮，修改提交地址为updatepostspinglun.action?id=${item.id}，删除提交地址为 deletepostspinglun.action?id=${item.id}-->

                                                <a href="updatepostspinglun.action?id=${item.id}">修改</a> <a
                                                    href="deletepostspinglun.action?id=${item.id}">删除</a>
