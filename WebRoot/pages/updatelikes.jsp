            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="updatelikesact.action"
                                    ...
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为novel的值为request中的likes.novel  */
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为novelid的值为request中的likes.novelid  */
                                    ...
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为user的值为request中的likes.user  */

                                                    $("#user").val("${likes.user}")</script>
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    /* 设置id为userid的值为request中的likes.userid  */

                                                    $("#userid").val("${likes.userid}")</script>
