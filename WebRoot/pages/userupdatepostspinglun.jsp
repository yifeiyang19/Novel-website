...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">修改帖子评论</title>
    <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">修改帖子评论</h4>
                        </div>
            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform"
                                      action="userupdatepostspinglunact.action" method="post"
                                      enctype="multipart/form-data">
                                    <input name='id' style='display:none;' value="${postspinglun.id}">
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="formselecttext">帖子</label>
                                                <!-- 定义帖子下拉框，并定义其onchange事件 -->

                                                <select id='posts' onchange="postschange(this)" name="posts"
                                                        class="select2 form-control" qw-c="formselect">
                                                    <!-- 使用c标签的if表达式判断 postsall是否为空 -->

                                                    <c:if test="${ !empty postsall}">

                                                        <!-- 使用c标签的forEach表达式循环输入 postsall -->

                                                        <c:forEach items="${ postsall}" var="item">
                                                ...
                                                <script>
                                                    ...
                                                    function postschange(select) {

                                                        /* 将id为postsid的项数设置为select的选中项的项数 */

                                                        $("#postsid").val($("#postsid option:eq(" + select.selectedIndex + ")").val());
                                                    }

                                                </script>
                                                <script>
                                                    /* 将id为posts值设置为request中的postspinglun.posts */

                                                    $("#posts").val("${postspinglun.posts}")</script>
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        ...
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div style='display:none;' class="form-group">
                                                <label class="col-form-label" qw-c="formselecttext">帖子id</label>
                                                <!-- 定义帖子id下拉框，并定义其onchange事件 -->

                                                <select id='postsid' onchange="postsidchange(this)" name="postsid"
                                                        class="select2 form-control" qw-c="formselect">
                                                    <!-- 使用c标签的if表达式判断 postsall是否为空 -->
                                                ...
                                                <script>
                                                    ...
                                                    function postsidchange(select) {

                                                        /* 将id为postsidid的项数设置为select的选中项的项数 */

                                                        $("#postsidid").val($("#postsidid option:eq(" + select.selectedIndex + ")").val());
                                                    }

                                                </script>
                                                <script>
                                                    /* 将id为postsid值设置为request中的postspinglun.postsid */

                                                    $("#postsid").val("${postspinglun.postsid}")</script>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="neirong" class="form-control"
                                                          qw-c="formtextarea">${postspinglun.neirong}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div style='display:none;' class="row" qw-c="forminputcomponent">
                                        ...
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div style='display:none;' class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">评论人</label>
                                                <input value="${sessionScope.userinfo.name}" name="pinglunrenmingzi"
                                    ...
                                    <div style='display:none;' class="row" qw-c="forminputcomponent">
                                        ...
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div style='display:none;' class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">评论人id</label>
                                                <input value="${sessionScope.userinfo.id}" name="pinglunrenid"
                                                       class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly value="${postspinglun.pinglunshijian}"
                                                       name="pinglunshijian" class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
