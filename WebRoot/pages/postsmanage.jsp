...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">帖子管理</title>
    <meta charset="utf-8">
                ...
                <div class="col xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">帖子管理</h4>
                        </div>
                                    ...
                                    <c:forEach items="${ postsall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改帖子按钮和删除帖子按钮，修改提交地址为updateposts.action?id=${item.id}，删除提交地址为 deleteposts.action?id=${item.id}-->

                                                <a href="updateposts.action?id=${item.id}">修改</a> <a
                                                    href="deleteposts.action?id=${item.id}">删除</a>
