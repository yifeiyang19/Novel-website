            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="userupdatecollectact.action"
                                    ...
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    /* 将id为novel值设置为request中的collect.novel */
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        ...
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <script>
                                                    /* 将id为novelid值设置为request中的collect.novelid */
