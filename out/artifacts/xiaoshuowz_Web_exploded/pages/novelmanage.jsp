...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">小说管理</title>
    <meta charset="utf-8">
                ...
                <div class="col xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">小说管理</h4>
                        </div>
                                    ...
                                    <c:forEach items="${ novelall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td> <!-- 将图片从服务器中获取并使用img展示，设置其宽高为100px -->
                                                ...
                                                <a href="resource/uploads/${item.pic }"><img
                                            ...
                                            <td> <!-- 将文件从服务器中获取并制作a标签链接到文件处进行下载 -->

                                                <a href="resource/uploads/${item.uploads }" download="${item.uploads }">下载</a>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改小说按钮和删除小说按钮，修改提交地址为updatenovel.action?id=${item.id}，删除提交地址为 deletenovel.action?id=${item.id}-->

                                                <a href="updatenovel.action?id=${item.id}">修改</a> <a
                                                    href="deletenovel.action?id=${item.id}">删除</a>
