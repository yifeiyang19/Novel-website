...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">帖子评论管理</title>
    <meta charset="utf-8">
                ...
                <div class="col xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">帖子评论管理</h4>
                        </div>
                                ...
                                <c:if test="${ !empty postspinglunall}">
                                    ...
                                    <c:forEach items="${ postspinglunall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td> ${item.pinglunrenmingzi }

                                            </td>
                                            <td> ${item.pinglunshijian }

                                            </td>
                                            <td>

                                                <!--  定义修改帖子评论按钮和删除帖子评论按钮，修改提交地址为userupdatepostspinglun.action?id=${item.id}，删除提交地址为 userdeletepostspinglun.action?id=${item.id}-->

                                                <a href="userupdatepostspinglun.action?id=${item.id}">修改</a> <a
                                                    href="userdeletepostspinglun.action?id=${item.id}">删除</a>
