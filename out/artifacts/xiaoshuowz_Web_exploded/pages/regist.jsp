...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">注册</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="resource/houtai/css/auth.css">
</head>
<body>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-img">
                    <img src="resource/houtai/picture/auth-img1.png" alt="">
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-content">
                    <form qw-c="form" action="registact.action" method="post">
                        <a href="#" class="ad-auth-logo"> <span style="font-size: 24px;font-weight: 700;">Novel website</span>
                        </a>
                        <h2><span class="primary">Hello,</span>Welcome!</h2>
                        <p>请在下面输入您的详细信息以继续</p>
                        <div class="ad-auth-form">
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" qw-c="username" placeholder="请输入用户名" name="username"
                                       class="ad-input">
                            ...
                            <div class="ad-auth-feilds">
                                <input type="password" qw-c="password" placeholder="请输入密码" name="password"
                                       class="ad-input">
                                <div class="ad-auth-icon">
                            ...
                            <div class="ad-auth-feilds" qw-c="passwordcomponent" style="margin-top: 20px;"><input
                                    type="password" qw-c="password" placeholder="请确认密码" name="repassword"
                                    class="ad-input">
                                <div class="ad-auth-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 482.8 482.8">
                                        <path d="M395.95,210.4h-7.1v-62.9c0-81.3-66.1-147.5-147.5-147.5c-81.3,0-147.5,66.1-147.5,147.5c0,7.5,6,13.5,13.5,13.5    s13.5-6,13.5-13.5c0-66.4,54-120.5,120.5-120.5c66.4,0,120.5,54,120.5,120.5v62.9h-275c-14.4,0-26.1,11.7-26.1,26.1v168.1    c0,43.1,35.1,78.2,78.2,78.2h204.9c43.1,0,78.2-35.1,78.2-78.2V236.5C422.05,222.1,410.35,210.4,395.95,210.4z M395.05,404.6    c0,28.2-22.9,51.2-51.2,51.2h-204.8c-28.2,0-51.2-22.9-51.2-51.2V237.4h307.2L395.05,404.6L395.05,404.6z"
                            ...
                            <div class="ad-auth-feilds" style="margin-top: 20px;">
                                <select qw-c="identity"
                                        style="width: 100%;height: 50px;border: 1px solid #ccc;border-radius: 5px;padding: 0 20px 0 20px"
                                        name="identity">
                                    <option>用户</option>
                                </select>
                            </div>
                        ...
                        <div class="ad-auth-btn">
                            <button qw-c="operationbutton" class="ad-btn ad-login-member">注册</button>
                        </div>
                        <p class="ad-register-text" qw-c="infotext">已有账号，点击<a href="login.action">登录</a></p>
                    </form>
                </div>
            </div>
        </div>
