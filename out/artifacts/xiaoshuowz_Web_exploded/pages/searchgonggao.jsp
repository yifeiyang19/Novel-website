...
<!--面包屑部分结束-->
<!--搜索区部分开始-->
<div id="lkapb2r5" qw-c="searchform" action="searchgonggao.action" method="post">
    <div class="sample one">
        <form qw-c="searchform" action="searchgonggao.action" method="post">
...
<div id="ljqv3fp1">
    <div class="shop__header">
        <h1 class="shop__title" qw-c="operationname">搜索公告</h1>
    </div>
