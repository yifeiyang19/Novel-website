                                    ...
                                    <c:forEach items="${ likesall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改点赞按钮和删除点赞按钮，修改提交地址为updatelikes.action?id=${item.id}，删除提交地址为 deletelikes.action?id=${item.id}-->

                                                <a href="updatelikes.action?id=${item.id}">修改</a> <a
                                                    href="deletelikes.action?id=${item.id}">删除</a>
