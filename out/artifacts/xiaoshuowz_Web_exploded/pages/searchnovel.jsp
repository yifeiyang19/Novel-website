...
<div id="ljp9xmrg">
    <nav aria-label="Breadcrumb" class="breadcrumb">
        <ul>
            ...
            <li><a href="#" qw-c="operationname">搜索小说</a></li>
        </ul>
    </nav>
</div>
<!--面包屑部分结束-->
<!--搜索区部分开始-->
<div id="lkapb2r5" qw-c="searchform" action="searchnovel.action" method="post">
    <div class="sample one">
        <form qw-c="searchform" action="searchnovel.action" method="post">
            ...
            <%--<button type="submit" id="searchbtn" class="btn btn-search fa fa-search" style="background: transparent;">搜索</button>--%>
        </form>
    </div>
</div>
<!--搜索区部分结束-->
...
<div id="ljqv3fp1">
    <div class="shop__header">
        <h1 class="shop__title" qw-c="operationname">搜索小说</h1>
    </div>
