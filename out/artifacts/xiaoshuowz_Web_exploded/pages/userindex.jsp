...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">修改用户个人信息</title>
    <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">修改用户个人信息</h4>
                        </div>
            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="userupdategerenxinxiact.action"
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">姓名</label>
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">账号</label>
                                                <!--  定义usernameinput，将session中的账号赋值给input  -->

                                                <input readonly value="${sessionScope.userinfo.username}" id="username"
                                                       name="username" class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">密码</label>
                                                <!--  定义password输入框，并从session中取值  -->

                                                <input value="${sessionScope.userinfo.password}" name="password"
                                                       class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">头像</label>
                                                <!--  定义toux文件选择框  -->

                                                <input type="file" value="${sessionScope.userinfo.toux}" id="toux"
                                                       name="touxfile" class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">性别</label>
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">年龄</label>
                                                <!--  定义age数字输入框  -->

                                                <input type="number" value="${sessionScope.userinfo.age}" name="age"
                                                       class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">手机号</label>
                                                <!--  定义phone输入框，并从session中取值  -->

                                                <input value="${sessionScope.userinfo.phone}" name="phone"
                                                       class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">邮箱</label>
                                    ...
                                    <div class="row" qw-c="formtextareacomponent">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="formtextareatext"></label>
                                                <!--  定义address文本输入框  -->

                                                <textarea name="address" class="form-control"
                                                          qw-c="formtextarea">${sessionScope.userinfo.address}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
