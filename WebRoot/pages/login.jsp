...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">登录</title>
    <meta charset="utf-8">
                ...
                <div class="ad-auth-content">
                    <form qw-c="form" action="loginact.action" method="post">
                        ...
                        <div class="ad-auth-btn">
                            <button qw-c="operationbutton" class="ad-btn ad-login-member">登录</button>
                        </div>
                        <p class="ad-register-text" qw-c="infotext">没有账号，点击<a href="regist.action">注册</a></p>
                    </form>
                </div>
            </div>
        </div>
