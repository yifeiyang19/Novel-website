...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">修改小说</title>
    <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">修改小说</h4>
                        </div>
            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="updatenovelact.action"
                                      method="post" enctype="multipart/form-data">
                                    <input name='id' style='display:none;' value="${novel.id}">
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">名称</label>
                                                <!-- 定义名称input输入框，并从request中取值novel.name赋值  -->
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">封面</label>
                                                <!-- 定义封面文件选择框  -->

                                                <input type="file" name="picfile" value="${novel.pic}"
                                    ...
                                    <div class="row" qw-c="formtextareacomponent">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="formtextareatext">描述</label>
                                                <textarea name="description" class="form-control"
                                                          qw-c="formtextarea">${novel.description}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">作者</label>
                                                <!-- 定义作者input输入框，并从request中取值novel.author赋值  -->
                                    ...
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="formselecttext">分类</label>
                                                <!-- 定义分类下拉框 -->

                                                <select id='category' onchange="categorychange(this)" name="category"
                                                        class="select2 form-control" qw-c="formselect">
                                                    <!-- 使用c标签的if表达式判断categoryall是否为空 -->
                                                ...
                                                <script>
                                                    /* 设置id为category的值为request中的novel.category  */

                                                    $("#category").val("${novel.category}")</script>
                                    ...
                                    <div style='display:none;' class="row" qw-c="formselectcomponent">
                                        <div style='display:none;' class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div style='display:none;' class="form-group">
                                                <label class="col-form-label" qw-c="formselecttext">分类id</label>
                                                <!-- 定义分类id下拉框 -->

                                                <select id='categoryid' onchange="categoryidchange(this)"
                                                        name="categoryid" class="select2 form-control"
                                                ...
                                                <script>
                                                    /* 设置id为categoryid的值为request中的novel.categoryid  */

                                                    $("#categoryid").val("${novel.categoryid}")</script>
                                    ...
                                    <div class="row" qw-c="forminputcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="forminputtext">上传</label>
                                                <!-- 定义上传文件选择框  -->

                                                <input type="file" name="uploadsfile" value="${novel.uploads}"
                                                       class="form-control" qw-c="forminput">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" qw-c="formselectcomponent">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="col-form-label" qw-c="formselecttext">状态</label>
                                                <!-- 定义状态下拉框 -->

                                                <select id='status' onchange="statuschange(this)" name="status"
                                                        class="select2 form-control" qw-c="formselect">
                                                    <option>待审核</option>
                                                    <option>不合规</option>
                                                    <option>已通过</option>
                                                ...
                                                <script>
                                                    /* 将id为status的组件赋值为request中的novel.status字段 */

                                                    $("#status").val("${novel.status}")</script>
