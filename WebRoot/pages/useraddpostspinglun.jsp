...
<!-- Begin Head -->
<head>
    <title qw-c="operationname">添加帖子评论</title>
    <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title" qw-c="operationname">添加帖子评论</h4>
                        </div>
            ...
            <div class="from-wrapper">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="separate-form" qw-c="operationform" action="useraddpostspinglunact.action"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id='posts' onchange="postschange(this)" name="posts"
                                                    ...
                                                    <c:if test="${ !empty postsall}">
                                                        ...
                                                        <!-- 使用c标签的forEach表达式循环postsall并将其name字段进行展示 -->
                                                ...
                                                <script>
                                                    ...
                                                    var posts = GetQueryString("posts");

                                                    if (posts != null) {

                                                        $("#posts").val(posts);

                                                        $("#posts option:selected").siblings().remove();
                                                    }
                                            ...
                                            <div style='display:none;' class="form-group">
                                                ...
                                                <select id='postsid' onchange="postsidchange(this)" name="postsid"
                                                    ...
                                                    <c:if test="${ !empty postsall}">
                                                        ...
                                                        <!-- 使用c标签的forEach表达式循环postsall并将其id字段进行展示 -->
                                                ...
                                                <script>
                                                    ...
                                                    var postsid = GetQueryString("postsid");

                                                    if (postsid != null) {

                                                        $("#postsid").val(postsid);

                                                        $("#postsid option:selected").siblings().remove();
                                                    }
