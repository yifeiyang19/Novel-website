                                    ...
                                    <c:forEach items="${ novelpinglunall}" var="item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--  定义修改小说评论按钮和删除小说评论按钮，修改提交地址为updatenovelpinglun.action?id=${item.id}，删除提交地址为 deletenovelpinglun.action?id=${item.id}-->

                                                <a href="updatenovelpinglun.action?id=${item.id}">修改</a> <a
                                                    href="deletenovelpinglun.action?id=${item.id}">删除</a>
